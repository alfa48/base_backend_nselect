...
public class TicketService extends BaseApiService {
    ...
    public PageResponse<TicketDTO> listarTicketsAdmin(int pagina, int tamanho) {
        return get("/tickets/admin/todos?pagina=" + pagina + "&tamanho=" + tamanho, new ParameterizedTypeReference<PageResponse<TicketDTO>>() {});
    }
